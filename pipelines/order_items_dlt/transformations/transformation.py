...
# ──────────────────────────────────────────────────────────────
@dlt.table(
    name    = "dlt_order_header",
    comment = "Gold – per-order revenue & counts."
)
def dlt_order_header():
    return (
        dlt.read_stream("dlt_order_items")
...
# ──────────────────────────────────────────────────────────────
@dlt.table(
    name           = "dlt_item_sales_day",
    partition_cols = ["day"],
    comment        = "Gold – item-level units & revenue by day."
)
def dlt_item_sales_day():
    return (
        dlt.read_stream("dlt_order_items")
           .groupBy(
